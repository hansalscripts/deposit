...
class PaymentController extends Controller
{
    public function deposit()
    {
        ...
        return view('gateway::user.payment.deposit', compact('gatewayCurrency', 'pageTitle'));
    }
    ...
    public function payment(Request $request)
    {
        ...
        return view('gateway::user.payment.deposit', compact('gatewayCurrency', 'pageTitle', 'plan', 'period'));
    }
    ...
    public function depositConfirm()
    {
        ...
        return view("gateway::$data->view", compact('data', 'pageTitle', 'deposit','masterBlade'));
    }
        ...
        if ($deposit->status == Status::PAYMENT_INITIATE || $deposit->status == Status::PAYMENT_PENDING) {
            ...
            if ($deposit->donation_id) {
                ...
                if ($donation->status == 0 || $donation->status == 2) {
                    ...
                    sendNotify($receiver, 'DONATION_RECEIVE', [
                    ...
                    sendNotify($sender, 'DONATION_SENT', [
                        'method_name' => $donation->payment_info,
                        'amount' => showAmount($donation->amount, currencyFormat: false),
                        'trx' => $deposit->trx,
                ...
                sendNotify($user, $isManual ? 'DEPOSIT_APPROVE' : 'DEPOSIT_COMPLETE', [
                ...
                if (isset($plan)) {
                    sendNotify($user, $isManual ? 'PURCHASE_REQUEST_APPROVE' : 'PLAN_PURCHASED', [
                        'plan_name'    => $plan->name,
    ...
    public function manualDepositConfirm()
    {
        ...
        if ($data->method_code > 999) {
            ...
            return view('gateway::user.payment.manual', compact('data', 'pageTitle', 'method', 'gateway', 'masterBlade'));
        }
        abort(404);
    }
    ...
    public function manualDepositUpdate(Request $request)
    {
        ...
        if (!$data->donation_id) {
            ...
            $adminNotification->save();
            sendNotify($data->user, $notifyType, $notifyBody);
