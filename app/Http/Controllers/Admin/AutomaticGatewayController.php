...
class AutomaticGatewayController extends Controller
{
    public function index()
    {
        ...
        return view('gateway::admin.gateways.automatic.list', compact('pageTitle', 'gateways'));
    }
    ...
    public function edit($alias)
    {
        ...
        return view('gateway::admin.gateways.automatic.edit', compact('pageTitle', 'gateway', 'supportedCurrencies', 'parameters', 'hasCurrencies', 'currencyIndex', 'globalParameters'));
    }
