...
class DepositController extends Controller
{
    public function pending($userId = null)
    {
        ...
        return view('gateway::admin.deposit.log', compact('pageTitle', 'deposits'));
    }
    ...
    public function deposit($userId = null)
    {
        ...
        return view('gateway::admin.deposit.log', compact('pageTitle', 'deposits','successful','pending','rejected','initiated'));
    }
    ...
    public function details($id)
    {
        ...
        return view('gateway::admin.deposit.detail', compact('pageTitle', 'deposit','details'));
    }
    ...
    public function reject(Request $request)
    {
        ...
        sendNotify($deposit->user, 'DEPOSIT_REJECT', [
